...
class Bosses:
    ...
    artio: Mapping[str, str] = field(default_factory=dict)
    ...
    calvalrion: Mapping[str, str] = field(default_factory=dict)
    ...
    duke_sucellus: Mapping[str, str] = field(default_factory=dict)
    ...
    lunar_chests: Mapping[str, str] = field(default_factory=dict)
    ...
    scurrius: Mapping[str, str] = field(default_factory=dict)
    skotizo: Mapping[str, str] = field(default_factory=dict)
    sol_heredit: Mapping[str, str] = field(default_factory=dict)
    spindel: Mapping[str, str] = field(default_factory=dict)
    ...
    the_leviathan: Mapping[str, str] = field(default_factory=dict)
    the_whisperer: Mapping[str, str] = field(default_factory=dict)
    ...
    vardorvis: Mapping[str, str] = field(default_factory=dict)
